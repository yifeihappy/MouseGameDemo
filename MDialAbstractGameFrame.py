...
class MDialAbstractGameFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.m_button_ISS = wx.Button(self, wx.ID_ANY, u"ISS", wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer_bottom.Add(self.m_button_ISS, 1, wx.ALL, 10)

        self.m_button_SERVER = wx.Button(self, wx.ID_ANY, u"SERVER", wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer_bottom.Add(self.m_button_SERVER, 1, wx.ALL, 10)
        ...
        # 显示ip
        bSizer_ip = wx.BoxSizer(wx.HORIZONTAL)
        self.m_staticText_IP_name = wx.StaticText(self, wx.ID_ANY, u"IP", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText_IP_name.Wrap(-1)
        self.m_staticText_IP_name.SetFont(wx.Font(20, 70, 90, 92, False, wx.EmptyString))
        self.m_staticText_IP_name.SetForegroundColour(wx.Colour(0, 255, 128))

        bSizer_ip.Add(self.m_staticText_IP_name, 0, wx.ALL, 5)

        self.m_staticText_IP_value = wx.StaticText(self, wx.ID_ANY, u"", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText_IP_value.Wrap(-1)
        self.m_staticText_IP_value.SetFont(wx.Font(20, 70, 90, 92, False, wx.EmptyString))
        self.m_staticText_IP_value.SetForegroundColour(wx.Colour(0, 255, 128))

        bSizer_ip.Add(self.m_staticText_IP_value, 1, wx.ALL, 5)

        # 显示ISS获取的key数量
        self.m_staticText_Key_num = wx.StaticText(self, wx.ID_ANY, u"Key Nums", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText_Key_num.Wrap(-1)
        self.m_staticText_Key_num.SetFont(wx.Font(20, 70, 90, 92, False, wx.EmptyString))
        self.m_staticText_Key_num.SetForegroundColour(wx.Colour(0, 0, 255))

        bSizer_ip.Add(self.m_staticText_Key_num, 0, wx.ALL, 5)

        self.m_staticText_Key_num_value = wx.StaticText(self, wx.ID_ANY, u"", wx.DefaultPosition, wx.DefaultSize, 0)
        self.m_staticText_Key_num_value.Wrap(-1)
        self.m_staticText_Key_num_value.SetFont(wx.Font(20, 70, 90, 92, False, wx.EmptyString))
        self.m_staticText_Key_num_value.SetForegroundColour(wx.Colour(0, 0, 255))

        bSizer_ip.Add(self.m_staticText_Key_num_value, 1, wx.ALL, 5)

        bSizer_all.Add(bSizer_ip)
        ...
        # Connect Events
        self.m_button_ISS.Bind(wx.EVT_BUTTON, self.iss_thread)
        self.m_button_SERVER.Bind(wx.EVT_BUTTON, self.server_thread)
